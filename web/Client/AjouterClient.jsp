...
<html>
    ...
    <body>
        ...
        <div class="container">
           ...
           <hr>
           <form action="client?action=add"  method="POST">
               ...
               <div class="form-group">
                   ...
                   <input type="date" name="date" class="form-control mb-4 col-4" required>
               </div>
               
                <div class="form-group">
                   <label for="adresse" class="control-label">Adresse du client</label>
                   <input type="text" name="adresse" class="form-control mb-4 col-4" required>
               </div>
             <div class="form-group">
               ...
               <div class="form-group">
                   <label for="solde" class="control-label">Montant d'ouverture</label>
